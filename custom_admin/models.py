...
class TemplateCopy(models.Model):
    ...
    url_clonar_page_especifica = models.URLField(verbose_name='URL da página especifica clonada', max_length=500, blank=True, null=True, help_text="")
    url_fake = models.CharField(verbose_name='URL que será enviada para a vítima', max_length=500, unique=True, help_text="")
